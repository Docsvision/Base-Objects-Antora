...
Текст стандартного XSLT-преобразования, используемого для формировании почтовых уведомлений исполнителям заданий, размещен на ресурсе GitHub в папке https://github.com/DocsVision/DeveloperItems/tree/master/xslt-templates/email-templates, файл [.ph .filepath]`EmailNotifications.xsl`.
