...
* xref:layouts/yes-no.adoc[Да/Нет],
* xref:layouts/lay_Elements_List.adoc[Список],
* xref:layouts/date-picker.adoc[Дата],
...
* xref:layouts/choose-folder.adoc[Выбор папки],
...
* xref:layouts/value-from-directory.adoc[Значение из справочника],
