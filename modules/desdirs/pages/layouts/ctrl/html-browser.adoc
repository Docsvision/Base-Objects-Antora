...
----
+
* *_Custom HTML_* -- пользовательский HTML. Будет использоваться предопределенный HTML-документ. Для использования элемента в поле _Пользовательские данные_ нужно указать содержимое html-документа (html-код).
