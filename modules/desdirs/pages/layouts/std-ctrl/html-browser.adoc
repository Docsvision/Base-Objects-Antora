...
Для элемента *HTML браузер* может быть локализовано свойство *XSL преобразование*. Добавление локализованных названий выполняется в окне _Локализация отображаемого значения_, открываемом при нажатии на кнопку image:buttons/globe.png[Земной шар] справа от поля.

.Добавление локализации для свойства "XSL преобразование"
image::html-localize.png[Добавление локализации для свойства "XSL преобразование"]
